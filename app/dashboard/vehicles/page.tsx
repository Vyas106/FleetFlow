...
import { Search, Filter, Truck, AlertCircle } from "lucide-react"
            ...
            <div className="flex flex-col sm:flex-row justify-between gap-4 items-start sm:items-center p-4 rounded-2xl bg-background/40 backdrop-blur-sm border border-border/40 shadow-sm">
                <div className="flex flex-1 w-full sm:w-auto items-center gap-2">
                    <div className="relative flex-1 sm:max-w-xs">
                        ...
                        <Input type="search" placeholder="Search license plates..." className="pl-9 w-full bg-background border-border/50 rounded-full" />
                    </div>
                    <Select>
                        ...
                        <SelectContent>
                            ...
                            <SelectItem value="on-trip">On Mission</SelectItem>
                                ...
                                <TableRow className="hover:bg-transparent">
                                    <TableCell colSpan={7} className="h-64 text-center">
                                        <div className="flex flex-col items-center justify-center text-muted-foreground gap-3">
                                            ...
                                            <p>No vehicles registered in the fleet yet.</p>
                                        </div>
                                    </TableCell>
                                </TableRow>
                            ) : (
